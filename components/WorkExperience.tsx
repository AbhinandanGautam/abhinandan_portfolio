...
const WorkExperience = () => {
  return (
    ...
    >
      ...
      <div className="w-full flex space-x-5 overflow-x-scroll scroll-smooth p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80" style={{'marginTop': '65px'}}>
