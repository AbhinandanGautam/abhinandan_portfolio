...
const experiences = [
  {
    ...
    _id: "2b09037b-c8b1-4431-ac3e-4a29ae27l12a",
    ...
    dateStarted: "2024-10-07",
    isCurrentlyWorkingHere: true,
    jobTitle: "SDE1 @ Seller Lending VS-VAR",
    points: [
      "Offer lending solutions and facilitate access to capital for our third-party sellers",
      "Develop innovative tools and cutting-edge technology to ensure delightful experience for our customers.",
    ],
    technologies: [
      {
  ...
  {
    _createdAt: "2022-10-31T09:11:56Z",
    _id: "2b09037b-c8b1-4431-ac3e-4a29ae27s26q",
    _rev: "j2Qg7fhhqYPp6sQH9kdfRi",
    _type: "experience",
    _updatedAt: "2022-10-31T09:11:56Z",
    company: "Accenture",
    companyImage:
      "/acn-lg.webp",
    dateStarted: "2024-06-26",
    dateEnded: "2024-09-18",
    isCurrentlyWorkingHere: false,
    jobTitle: "Advanced App Engineering Analyst",
    points: [
      "Completed an in-depth AI Foundation program covering a wide range of skills in AI and machine learning",
      "Familiar with generative AI concepts and retrieval-augmented generation (RAG).",
      "Knowledgeable in deep learning, NLP, computer vision, and reinforcement learning.",
    ],
    technologies: [
      {
